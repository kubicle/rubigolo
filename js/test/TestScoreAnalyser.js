...
TestScoreAnalyser.prototype.testComputeScore = function () {
    this.initGame(7, 1.5);
    var s = this.sa.computeScoreAsTexts(this.game);
    ...
    s = this.sa.computeScoreAsTexts(this.game);
...
TestScoreAnalyser.prototype.testComputeScoreDiff = function () {
    this.initGame(7, 3.5);
    this.assertEqual(-8.5, this.sa.computeScoreDiff(this.game));
};

TestScoreAnalyser.prototype.testScoreInfo = function () {
    this.initGame(7, 0.5);
    var i = this.sa.computeScoreInfo(this.game);
...
TestScoreAnalyser.prototype.testScoringGrid = function () {
    this.initGame(7, 1.5);
    this.sa.computeScoreDiff(this.game);
