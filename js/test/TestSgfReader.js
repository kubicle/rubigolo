...
TestSgfReader.prototype.test_1 = function () {
    ...
    assertEqual(19, reader.board_size);
    assertEqual([], reader.handicap_stones);
    ...
    return assertEqual(exp_moves, moves);
};
...
TestSgfReader.prototype.test_2 = function () {
    ...
    assertEqual(19, reader.board_size);
    assertEqual(['p16', 'd4', 'p4', 'd16', 'p10', 'd10'], reader.handicap_stones);
    var moves = reader.to_move_list();
